  ...
  return (
    <div className="back-cen">
      <div className="post-tab">
        ...
        <button
          onClick={() => handleTabClick("TweetManage")}
          className={`post-button ${
            activeTab === "TweetManage" ? "active" : ""
          }`}
        >
          <i className="fa-solid fa-list"></i>Tweet Manage
        </button>
        <button
        ...
        <div className="back-center">
          ...
          <div className="back-grey">
            <input
              ...
              placeholder="tweet or @profileId"
            />
            <button className="search-tweet" onClick={handleSearch}>
              Search
            </button>
          </div>
              ...
              {tweets.map((tweet) => (
                <tr key={tweet._id}>
                  <td>
                    <input
                      type="checkbox"
                      onChange={() => handleCheckboxChange(tweet._id)}
      ...
      {activeTab === "banManage" && (
        <div className="back-center">
          ...
          <div className="back-grey">
            ...
            />
            <button className="search-tweet" onClick={handleAddWord}>
