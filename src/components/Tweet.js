          ...
          <div className="post-tab">
            <button
              ...
              className={`post-button ${
                activeTab === "recentTweet" ? "active" : ""
              }`}
            >
              <i className="fa-solid fa-fire-flame-curved"></i>Recent Tweet
            </button>
            <button
            ...
            >
              <i className="fa-solid fa-hashtag"></i>Following
            </button>
          </div>
          <TweetPost />
          <ToastContainer />
          <div>
                ...
                {tweets.map((tweet) => (
                  <div className="tweet" key={tweet._id}>
                    ...
                    <div className="button-group">
                      ...
                      <button
                        className={
                          likedTweets.includes(tweet._id) ? "liked" : ""
                        }
            ...
            {activeTab === "following" && (
              <div className="twee-map">
                {tweets
                  .filter(
                    (tweet) => followStatus[tweet.profile_id] === "Following"
                  )
                  .map((tweet) => (
                    <div className="tweet" key={tweet._id}>
                      <div className="opos">
